<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AR505050.aspx.cs" Inherits="Page_AR505050" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.ACH.ARProcessPayment" PrimaryView="Filter" PageLoadBehavior="GoLastRecord" />
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="288px" Style="z-index: 100" Width="100%" Caption="Payments" AllowPaging="true" AdjustPageSize="Auto"
        SkinID="PrimaryInquire" SyncPosition="True" FastFilterFields="ExtRefNbr,RefNbr,CustomerID,CustomerID_Customer_acctName">
        <Levels>
            <px:PXGridLevel DataMember="ARPaymentList">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="CustomerID_Customer_acctName" Width="250px" />
